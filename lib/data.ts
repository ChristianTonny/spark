...
export const assessments: Assessment[] = [
  {
    ...
    questions: [
      ...
      {
        id: "q7",
        text: "How comfortable are you with using computers and technology?",
        type: "multiple_choice",
        options: [
          "Very comfortable - I love learning new tech",
          "Comfortable - I can use most common tools",
          "Somewhat comfortable - I know the basics",
          "Not very comfortable - I prefer minimal tech",
        ],
      },
      {
        id: "q8",
        ...
        options: [
          ...
          "Writing a story or creating a video",
          "Starting a business or club",
        ],
      },
      {
        id: "q9",
        text: "How do you handle challenges or setbacks?",
        type: "multiple_choice",
        options: [
          "I analyze what went wrong and try again",
          "I ask others for help and advice",
          "I take a break and come back with fresh ideas",
          "I look for alternative approaches",
        ],
      },
      {
        id: "q10",
        ...
        type: "multiple_choice",
        options: [
          "Solve technical problems and create innovation",
      ...
      {
        id: "q11",
        text: "How much education/training are you willing to pursue?",
        type: "multiple_choice",
        options: [
          "4+ years (University degree or more)",
          "2-3 years (Diploma or certificate)",
          "On-the-job training (Learn while working)",
          "I'm open to whatever is required",
        ],
      },
      {
        id: "q12",
        text: "Which Rwanda industry excites you most?",
        type: "multiple_choice",
        options: [
      ...
      {
        id: "q13",
        text: "Do you prefer work that is:",
        type: "multiple_choice",
        options: [
          "Structured with clear routines",
          "Varied with different tasks each day",
          "Project-based with deadlines",
          "Flexible with self-directed goals",
        ],
      },
      {
        id: "q14",
        text: "How important is working directly with people?",
        type: "multiple_choice",
        options: [
          "Very important - I love interacting with others",
          "Somewhat important - I like balance",
      ...
      {
        id: "q15",
        text: "What describes your ideal career path?",
        type: "multiple_choice",
        options: [
          "Specialist - becoming an expert in one area",
          "Generalist - knowing a bit about many things",
          "Entrepreneur - starting my own business",
          "Leader - managing teams and projects",
        ],
      },
    ],
  },
